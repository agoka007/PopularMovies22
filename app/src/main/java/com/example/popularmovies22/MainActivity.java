...
import com.example.popularmovies22.model.MoviesClass;
import com.example.popularmovies22.utilities.JsonUtils;
import com.example.popularmovies22.utilities.NetworkUtils;
...
public class MainActivity extends AppCompatActivity implements MovieAdapter.ListItemClickListener {
    ...
    private String mRecyclerPositionKey = "position";
    ...
    {
        super.onPause();
        listState = mMovieRecyclerView.getLayoutManager().onSaveInstanceState();
    }
}